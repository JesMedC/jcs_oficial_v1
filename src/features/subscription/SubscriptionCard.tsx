    ...
    return (
      <GlassCard variant="elevated" className="p-6 md:p-8">
        <div className="flex flex-col gap-4">
          ...
          <Link
            to="/portal/upgrade"
            className="self-start inline-flex bg-primary text-bg font-display uppercase tracking-wide px-4 py-2 rounded-lg hover:shadow-[0_0_24px_rgba(0,255,157,0.5)] transition-shadow text-sm" // design-system-v1 (Wave 3d, T3d.1) — cyan hover-shadow swapped for neon jade rgba(0,255,157,*).
          >
            Activar suscripcion
          </Link>
        </div>
    ...
    <GlassCard variant="elevated" className="p-6 md:p-8">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-wrap gap-3 mt-2">
          <Link
            to={cta.to}
            className="inline-flex bg-primary text-bg font-display uppercase tracking-wide px-4 py-2 rounded-lg hover:shadow-[0_0_24px_rgba(0,255,157,0.5)] transition-shadow text-sm" // design-system-v1 (Wave 3d, T3d.1) — cyan hover-shadow swapped for neon jade rgba(0,255,157,*).
          >
            {cta.label}
          </Link>
        </div>
